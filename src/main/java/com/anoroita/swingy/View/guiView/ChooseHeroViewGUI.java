...
public class ChooseHeroViewGUI extends JPanel {
    ...
    public void start() {
        guiController = new GuiController(this, 1);
    ...
    private void buildUI() {
        ...
        String[] data = guiController.getListData();
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    if (list.getSelectedIndex() != -1) {
                        guiController.onListElementSelected(list.getSelectedIndex());
        ...
        selectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                guiController.onSelectButtonPressed(lastSelectedIdx);
            }
        });
        createButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                guiController.onCreateButtonPressed();
            }
        });
    }
