...
import com.anoroita.swingy.Controller.GuiController;
...
public class GameViewGUI extends JPanel {
    ...
    private JEditorPane PlaygroundPane = new JEditorPane();
    private GuiController guiManager;
    private View game;


    public void start(GameCharacter hero) {
        guiManager = new GuiController(this, 2);
    ...
    private void buildUI() {
        ...
        PlaygroundPane.setEditable(false);
        PlaygroundPane.setText("Playground");
        JScrollPane PlaygroundScroll = new JScrollPane(infoPane);
        PlaygroundScroll.setPreferredSize(new Dimension(300, 300));
        PlaygroundScroll.setMinimumSize(new Dimension(200, 200));
        // this.add(infoPane, gbc);
        this.add(PlaygroundScroll, gbc);
